...
public class Student {
	...
	public Student(String firstName, String lastName, int studentNumber, float algoGrade, float pythonGrade) {
	...
	public Student(int id, String firstName, String lastName, int studentNumber, float algoGrade, float pythonGrade) {
		this.id = id;
		this.firstName = firstName;
		this.lastName = lastName;
		this.studentNumber = studentNumber;
